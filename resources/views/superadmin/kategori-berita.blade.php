    ...
    <div class="p-16 sm:ml-64">
        <div class="p-8 bg-white border-2 border-gray-100 rounded-lg dark:border-gray-700 mt-14">
            <div class="flex flex-row justify-between mb-8">
                <a href="{{ route('super-create-kategori-berita') }}"
                    ...
                    <span class="ml-2">Buat Kategori Berita</span>
                </a>
                {{-- <div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-center text-gray-500">
                    ...
                    <tbody>
                        @foreach ($kategori_berita as $value)
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-10 flex flex-row  justify-center">
                                    <a href="{{ route('super-edit-kategori-berita', $value->id) }}"

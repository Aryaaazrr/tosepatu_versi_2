    ...
    <div class="p-16 sm:ml-64">
        <div class="p-2 bg-white border-2 border-gray-100 rounded-lg dark:border-gray-700 mt-14">
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{ route('super-store-metode-pengaturan-toko') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
